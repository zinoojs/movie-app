...
<head>
    ...
    <title>Movie App For Movies Crazy</title>
...
<body class="font-sans bg-gray-900 text-white">
    <nav class="border-b border-gray-800">
        <div class="container mx-auto flex flex-col md:flex-row px-4 items-center  justify-between py-6 px-4">
            <ul class="flex flex-col md:flex-row items-center">
                ...
                <li class="md:ml-16  md:mt-0 mt-3">
                    <a href="{{ route('movie.index')}}" class="hover:text-gray-400">Movies</a>
                </li>
            ...
            <div class="flex items-center flex-col md:flex-row  md:mt-0 mt-3">
               <livewire:search-dropdown>
                <div class="md:ml-4 md:mt-0 mt-3">
                    <a href=""><img src="/img/photo.jpg" alt="" class="w-8 h-8 rounded-full"></a>
                </div>
            </div>
        </div>
    </nav>
